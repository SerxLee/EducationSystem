...
//        self.cancelButton.frame = CGRectMake(0, rawHeight - 40, barWidth, 40)
    ...
    func selectIcon(){
        ...
        if UIDevice.currentDevice().userInterfaceIdiom == UIUserInterfaceIdiom.Pad {
            userIconAlert.popoverPresentationController?.sourceView = currentController?.view
            userIconAlert.popoverPresentationController?.sourceRect = CGRectMake((barWidth - 80) / 2 + 40, 0, 1, 125)
        }
    ...
    func selectedBackgroundImage(){
        ...
        if UIDevice.currentDevice().userInterfaceIdiom == UIUserInterfaceIdiom.Pad {
            userIconAlert.popoverPresentationController?.sourceView = currentController?.view
            userIconAlert.popoverPresentationController?.sourceRect = CGRect(x: 100, y:120, width: 100, height: 400)
        }
        currentController?.presentViewController(userIconAlert, animated: true, completion: nil)
    }
